# BloomBooks.Velopack (Unsupported Fork)

This unlisted NuGet package is a localization-focused fork of the Velopack project. It is maintained by the Bloom team solely to support BloomBooks distribution scenarios and may lag behind upstream releases.
